...
class WeatherNetworkManager : NetworkProtocol {
    
    func fetchCurrentLocationWeather(lat: String, lon: String, completion: @escaping (WeatherModel) -> ()) {
        let API_URL = "\(NetworkConstants.Base_URL)/wether?lat=\(lat)&lon=\(lon)&appid=\(NetworkConstants.API_KEY)"
    ...
    func fetchCurrentWeather(city: String, completion: @escaping (WeatherModel) -> ()) {
        ...
        let API_URL = "\(NetworkConstants.Base_URL)/weather?q=\(formattedCity)&appid=\(NetworkConstants.API_KEY)"
    ...
    func fetchFiveDaysWeatherForecast(city: String, completion: @escaping ([ForecastTemperature]) -> ()) {
        let formattedCity = city.replacingOccurrences(of: " ", with: "+")
        let API_URL = "\(NetworkConstants.Base_URL)/forecast?q=\(formattedCity)&appid=\(NetworkConstants.API_KEY)"
